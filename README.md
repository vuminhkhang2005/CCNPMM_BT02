...
### 1. CRUD Cơ bản (Thành viên: Bùi Thanh Tùng)
- Thêm dữ liệu: http://localhost:8088/crud
- Xem dữ liệu: http://localhost:8088/get-crud

### 2. Authentication & Security - Login API (Thành viên: Vũ Minh Khang - 23110238)
